...
window.TRANSLATIONS.en = {
  "header_title": "XtremeShld Settings",
  ...
  "companion_desc": "From the creators of XtremeShld: Download streaming videos, m3u8 playlists, and audio streams directly at maximum speed.",
  "companion_btn": "Try StreamGrabber 2",
  "whitelist_title": "Trusted Whitelisted Domains",
  "whitelist_desc": "XtremeShld will remain completely disabled on these websites.",
  ...
  "reset_confirm": "Are you sure you want to reset all XtremeShld settings to defaults? This will clear custom rules and whitelists.",
  "import_success": "XtremeShld configuration successfully imported!",
  "import_error": "Invalid JSON file format.",
  "copied": "Copied!",
  "rec_tool_title": "🎬 Recommended Extension: StreamGrabber 2",
  "rec_tool_desc": "Need to download videos, audio streams, or HLS (.m3u8) clips for offline playback? Try <strong>StreamGrabber 2</strong>, our high-speed video sniffer and downloader extension.",
  "rec_tool_btn": "🚀 Try StreamGrabber 2 Free",
  "donations_title": "💖 100% Free & Open Privacy Model",
  "donations_desc": "Unlike commercial adblockers that sell user telemetry or charge monthly subscriptions for \"premium\" features, <strong>XtremeShld is 100% free, forever, with zero paywalls</strong>. We rely strictly on voluntary community donations from users who value high-speed, private browsing.",
  "donations_ways": "Ways to Support XtremeShld",
  ...
  "feature_details": {
    ...
    "toasts": {
      ...
      "benefit": "Provides transparent real-time feedback on what XtremeShld is blocking, with instant unblock controls.",
...
window.TRANSLATIONS.es = {
  "header_title": "Configuración de XtremeShld",
  ...
  "companion_desc": "De los creadores de XtremeShld: Descarga videos en streaming, listas m3u8 y pistas de audio a máxima velocidad.",
  "companion_btn": "Probar StreamGrabber 2",
  "whitelist_title": "Dominios de Confianza (Lista Blanca)",
  "whitelist_desc": "XtremeShld permanecerá completamente deshabilitado en estos sitios web.",
  ...
  "reset_confirm": "¿Estás seguro de que deseas restablecer la configuración de XtremeShld? Esto borrará tus reglas y listas blancas.",
  "import_success": "¡Configuración de XtremeShld importada con éxito!",
  "import_error": "Formato de archivo JSON inválido.",
  "copied": "¡Copiado!",
  "rec_tool_title": "🎬 Extensión Recomendada: StreamGrabber 2",
  "rec_tool_desc": "¿Necesitas descargar videos, transmisiones de audio o clips HLS (.m3u8) para ver sin conexión? Prueba <strong>StreamGrabber 2</strong>, nuestro descargador de video de alta velocidad.",
  "rec_tool_btn": "🚀 Probar StreamGrabber 2 Gratis",
  "donations_title": "💖 Modelo de Privacidad 100% Gratuito y Libre",
  "donations_desc": "A diferencia de bloqueadores comerciales que venden tus datos de navegación o cobran suscripciones mensuales, <strong>XtremeShld es 100% gratuito, para siempre, sin muros de pago</strong>. Dependemos únicamente de donaciones voluntarias de usuarios que valoran una navegación privada y rápida.",
  "donations_ways": "Formas de Apoyar a XtremeShld",
...
window.TRANSLATIONS.zh = {
  "header_title": "XtremeShld 设置与控制中心",
  ...
  "companion_desc": "由 XtremeShld 团队匠心打造：极速嗅探并直接下载各类在线流媒体视频、m3u8 播放列表及音频资源。",
  "companion_btn": "体验 StreamGrabber 2",
  "whitelist_title": "信任网站名单（白名单）",
  "whitelist_desc": "XtremeShld 将在这些网站上完全处于停用状态，不做任何拦截与脚本注入。",
  ...
  "reset_confirm": "确定要将 XtremeShld 的所有设置重置为默认值吗？这将清空白名单和自定义规则。",
  "import_success": "XtremeShld 配置已成功导入！",
  "import_error": "JSON 文件格式无效，请检查文件。",
  "copied": "已复制！",
  "rec_tool_title": "🎬 推荐扩展：StreamGrabber 2",
  "rec_tool_desc": "想要将网页视频、音乐或 HLS (.m3u8) 分段流下载到本地离线观看？试试 <strong>StreamGrabber 2</strong>，我们的高速视频嗅探与下载伴侣扩展。",
  "rec_tool_btn": "🚀 免费体验 StreamGrabber 2",
  "donations_title": "💖 100% 永久免费与开源隐私理念",
  "donations_desc": "与收集用户浏览足迹贩卖数据、或针对核心功能收取订阅费的商业插件不同，<strong>XtremeShld 始终 100% 免费，无任何付费墙</strong>。我们完全依靠珍视隐私与极速冲浪体验的社区用户自愿赞助。",
...
window.TRANSLATIONS.ru = {
  "header_title": "Настройки XtremeShld",
  ...
  "companion_desc": "От создателей XtremeShld: Загружайте потоковые видео, плейлисты m3u8 и аудиофайлы на максимальной скорости.",
  "companion_btn": "Попробовать StreamGrabber 2",
  "whitelist_title": "Доверенные домены (Белый список)",
  "whitelist_desc": "XtremeShld будет полностью отключен на этих сайтах.",
  ...
  "reset_confirm": "Вы уверены, что хотите сбросить все настройки XtremeShld? Это очистит белый список и персональные правила.",
  "import_success": "Конфигурация XtremeShld успешно импортирована!",
  "import_error": "Неверный формат файла JSON.",
  "copied": "Скопировано!",
  "rec_tool_title": "🎬 Рекомендуемое расширение: StreamGrabber 2",
  "rec_tool_desc": "Нужно скачать потоковое видео, аудиодорожки или фрагменты HLS (.m3u8) для офлайн-просмотра? Попробуйте <strong>StreamGrabber 2</strong> — наш быстрый загрузчик медиафайлов.",
  "rec_tool_btn": "🚀 Попробовать StreamGrabber 2 бесплатно",
  "donations_title": "💖 100% Бесплатная модель приватности",
  "donations_desc": "В отличие от коммерческих блокировщиков, продающих данные пользователей или требующих платную подписку, <strong>XtremeShld бесплатен навсегда и не содержит платных функций</strong>. Мы существуем исключительно за счет добровольных пожертвований пользователей.",
  "donations_ways": "Способы поддержать XtremeShld",
